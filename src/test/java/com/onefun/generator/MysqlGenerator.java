...
public class MysqlGenerator {
    ...
    private static String[] table=new String[]{"t_photo"};//t_user
    ...
    private static String url ="jdbc:mysql://gz-cdb-jkxfrmj7.sql.tencentcdb.com:62701/db_tanabata_photo?useUnicode=true&characterEncoding=UTF-8&tinyInt1isBit=false";
